# coding=utf-8
__author__ = 'lnx3032'  # from https://github.com/AirtestProject/my-testflow
...
def install_android_app(adb_client, localpath, force_reinstall=False):
    ...
    print('installed version is {}, installer version is {}. force_reinstall={}'.format(installed_version, apk_version,
                                                                                        force_reinstall))
